export const ADMIN_USERS=[{email:'admin@verifyx.com',password:'admin123',role:'ADMIN',name:'Admin User'},{email:'hr@verifyx.com',password:'hr123',role:'HR',name:'HR Manager'}];
...
export const SKILLS=['C','C++','Java','Python','C#','.NET','ASP.NET MVC','Spring Boot','React.js','Angular','Node.js','HTML','CSS','JavaScript','TypeScript','SQL','MySQL','SQL Server','Oracle','MongoDB','Firebase','Git','GitHub','AWS','Azure','Docker','Manual Testing','Power BI'];
...
export const DOCS_FRESHER=['Resume','Passport Photo','Degree Certificate','ID Proof'];
